...
We provide below all the code for the problem-specific components.  We use the R package [`glmnet`](https://cran.r-project.org/web/packages/glmnet/index.html) to fit the elastic net.  The most distinctive feature of this particular vignette is how the list of methods `list_of_elastic_nets` was created.  This is shown in the Methods section.
