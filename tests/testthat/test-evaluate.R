...
test_that("evaluate handles arguments as desired", {
  ...
  evaluate(l1_error, dir, "tm", 1:2, "his")
  evals12b <- load_evals(dir, "tm", 1:2, "his")
  expect_identical(subset_evals(evals12a, method="his"), evals12b)
  expect_error(load_evals(dir, "tm", 1:2, c("his","my")), "different sets")
  evaluate(list(squared_error, l1_error, linf_error),
           dir, "tm", 2:3, c("my", "his"))
  evals <- load_evals(dir, "tm", 2, c("his","my"))
